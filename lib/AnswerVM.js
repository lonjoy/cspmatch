...
AnswerVM.prototype.run = function (code, options) {
	...
	try {
		var sandbox = {'$': sb,
			...
			Buffer: Buffer, require: function () { return require.apply(this, arguments); }, console: console, debug: console.log,
			data: sb.data, argv: sb.argv, print: function () { return sb.print.apply(sb, arguments); },
